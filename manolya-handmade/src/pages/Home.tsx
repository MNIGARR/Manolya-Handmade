    ...
    <div>
      <section className="container mx-auto px-6 py-16 md:py-24 grid md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <h1 className="text-5xl md:text-6xl font-bold text-manolya-purple leading-tight mb-6">
        ...
        <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-100 max-w-md mx-auto md:max-w-none">
      ...
      <section className="container mx-auto px-6 py-20">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-manolya-purple mb-4">Featured Collection</h2>
        </div>
