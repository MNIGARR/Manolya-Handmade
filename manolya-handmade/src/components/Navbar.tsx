    ...
    <header className="bg-white sticky top-0 z-50 border-b border-gray-100 shadow-sm">
      <nav className="container mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center gap-2 flex-shrink-0">
          <div className="w-10 h-10 rounded-full overflow-hidden border-2 border-manolya-purple/20">
            <img src={logoImg} alt="Manolya Handmade Logo" className="w-full h-full object-cover" />
          </div>
        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          {currentUser ? (
            <div className="flex items-center gap-3 ml-2">
              <span className="text-manolya-purple font-semibold text-sm">
          ...
          <div className="pt-3">
            {currentUser ? (
              <div className="flex items-center justify-between">
                <span className="text-manolya-purple font-semibold text-sm">Hi, {currentUser.name.split(' ')[0]} 👋</span>
              ...
              <Link to="/login" className="block bg-manolya-purple text-white px-5 py-2.5 rounded-md hover:bg-purple-700 transition text-center font-medium" onClick={() => setMenuOpen(false)}>
                Sign In
              </Link>
            )}
          </div>
