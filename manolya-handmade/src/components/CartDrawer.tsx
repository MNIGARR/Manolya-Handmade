          ...
          {cartItems.length === 0 ? (
            ...
            cartItems.map((item) => (
              <div key={item.id} className="flex gap-4 border-b border-gray-100 pb-4">
                ...
                <div className="flex-grow min-w-0">
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    <button
                      ...
                      className="w-7 h-7 rounded-full border border-gray-300 flex items-center justify-center text-gray-600 hover:bg-gray-100 transition text-base font-bold leading-none"
                      aria-label="Decrease quantity"
                    >
                      −
                    </button>
                    <span className="w-6 text-center font-semibold text-gray-800 text-sm select-none">{item.quantity}</span>
                    <button
                      onClick={() => onUpdateQuantity(item.id, 1)}
                      className="w-7 h-7 rounded-full border border-gray-300 flex items-center justify-center text-gray-600 hover:bg-gray-100 transition text-base font-bold leading-none"
                ...
                <button onClick={() => onRemove(item.id)} className="text-red-400 hover:text-red-600 text-xs self-start flex-shrink-0 mt-1">
                  Remove
                </button>
              </div>
            ))
        ...
        {cartItems.length > 0 && (
          <div className="p-6 border-t border-gray-100 bg-gray-50">
            ...
            <button
              ...
              className="w-full bg-manolya-purple text-white py-3 rounded-md hover:bg-purple-700 transition font-medium shadow-sm"
            >
              Proceed to Checkout
            </button>
          </div>
